...
# TODO требуется оптимизировать код в блоке if-else: сейчас в обоих ветках есть дубликаты (практически идентичный код)
# TODO для этого вынесите значение в отдельную переменную shift, которое изменяется в зависимости от условия
